...
//CHECK: @"\01??_R1A@?0A@EA@third@@8" = linkonce_odr constant { i8*, i32, i32, i32, i32, i32 } { i8* bitcast ({ i8**, i32, [12 x i8] }* @"\01??_R0?AVthird@@@8" to i8*), i32 3, i32 0, i32 -1, i32 0, i32 64 }
//CHECK: @"\01??_R0?AVfourth@@@8" = linkonce_odr constant { i8**, i32, [13 x i8] } { i8** @"\01??_7type_info@@6B@", i32 0, [13 x i8] c".?AVfourth@@\00" }
//CHECK: @"\01??_R13?0A@EA@fourth@@8" = linkonce_odr constant { i8*, i32, i32, i32, i32, i32 } { i8* bitcast ({ i8**, i32, [13 x i8] }* @"\01??_R0?AVfourth@@@8" to i8*), i32 0, i32 4, i32 -1, i32 0, i32 64 }
//CHECK: @"\01??_R0?AVsecond@@@8" = linkonce_odr constant { i8**, i32, [13 x i8] } { i8** @"\01??_7type_info@@6B@", i32 0, [13 x i8] c".?AVsecond@@\00" }
//CHECK: @"\01??_R1A@73FN@second@@8" = linkonce_odr constant { i8*, i32, i32, i32, i32, i32 } { i8* bitcast ({ i8**, i32, [13 x i8] }* @"\01??_R0?AVsecond@@@8" to i8*), i32 1, i32 0, i32 8, i32 4, i32 93 }
//CHECK: @"\01??_R0?AVfirst@@@8" = linkonce_odr constant { i8**, i32, [12 x i8] } { i8** @"\01??_7type_info@@6B@", i32 0, [12 x i8] c".?AVfirst@@\00" }
//CHECK: @"\01??_R1A@73EN@first@@8" = linkonce_odr constant { i8*, i32, i32, i32, i32, i32 } { i8* bitcast ({ i8**, i32, [12 x i8] }* @"\01??_R0?AVfirst@@@8" to i8*), i32 0, i32 0, i32 8, i32 4, i32 77 }
//CHECK: @"\01??_R2third@@8" = linkonce_odr constant [4 x { i8*, i32, i32, i32, i32, i32 }*] [{ i8*, i32, i32, i32, i32, i32 }* @"\01??_R1A@?0A@EA@third@@8", { i8*, i32, i32, i32, i32, i32 }* @"\01??_R13?0A@EA@fourth@@8", { i8*, i32, i32, i32, i32, i32 }* @"\01??_R1A@73FN@second@@8", { i8*, i32, i32, i32, i32, i32 }* @"\01??_R1A@73EN@first@@8"]
//CHECK: @"\01??_R3third@@8" = linkonce_odr constant { i32, i32, i32, i8* } { i32 0, i32 7, i32 4, i8* bitcast ([4 x { i8*, i32, i32, i32, i32, i32 }*]* @"\01??_R2third@@8" to i8*) }
//CHECK: @"\01??_R4third@@6B0@@" = linkonce_odr unnamed_addr constant { i32, i32, i32, i8*, i8* } { i32 0, i32 0, i32 0, i8* bitcast ({ i8**, i32, [12 x i8] }* @"\01??_R0?AVthird@@@8" to i8*), i8* bitcast ({ i32, i32, i32, i8* }* @"\01??_R3third@@8" to i8*) }
//CHECK: @"\01??_R4third@@6Bsecond@@@" = linkonce_odr unnamed_addr constant { i32, i32, i32, i8*, i8* } { i32 0, i32 16, i32 0, i8* bitcast ({ i8**, i32, [12 x i8] }* @"\01??_R0?AVthird@@@8" to i8*), i8* bitcast ({ i32, i32, i32, i8* }* @"\01??_R3third@@8" to i8*) }
...
//CHECK: @"\01??_R1A@?0A@EA@second@@8" = linkonce_odr constant { i8*, i32, i32, i32, i32, i32 } { i8* bitcast ({ i8**, i32, [13 x i8] }* @"\01??_R0?AVsecond@@@8" to i8*), i32 1, i32 0, i32 -1, i32 0, i32 64 }
...
//CHECK: @"\01??_R2second@@8" = linkonce_odr constant [2 x { i8*, i32, i32, i32, i32, i32 }*] [{ i8*, i32, i32, i32, i32, i32 }* @"\01??_R1A@?0A@EA@second@@8", { i8*, i32, i32, i32, i32, i32 }* @"\01??_R1A@?0A@EN@first@@8"]
//CHECK: @"\01??_R3second@@8" = linkonce_odr constant { i32, i32, i32, i8* } { i32 0, i32 0, i32 2, i8* bitcast ([2 x { i8*, i32, i32, i32, i32, i32 }*]* @"\01??_R2second@@8" to i8*) }
//CHECK: @"\01??_R4second@@6B@" = linkonce_odr unnamed_addr constant { i32, i32, i32, i8*, i8* } { i32 0, i32 0, i32 0, i8* bitcast ({ i8**, i32, [13 x i8] }* @"\01??_R0?AVsecond@@@8" to i8*), i8* bitcast ({ i32, i32, i32, i8* }* @"\01??_R3second@@8" to i8*) }
