...
// CHECK: @"\01__CTA1?AUA@@" = constant { i32, %catchable.type* } { i32 1, %catchable.type* @"\01__CT??_R0?AUA@@@81" }
// CHECK: @"\01__TI1?AUA@@" = constant %throw.info.type { i32 0, void ()* bitcast (void (%struct.A*)* @"\01??1A@@QAE@XZ" to void ()*), i32 ()* null, %catchable.array.type* bitcast ({ i32, %catchable.type* }* @"\01__CTA1?AUA@@" to %catchable.array.type*) }
...
// CHECK: @"\01__CTA2?AUB@@" = constant { i32, %catchable.type*, %catchable.type* } { i32 2, %catchable.type* @"\01__CT??_R0?AUB@@@81", %catchable.type* @"\01__CT??_R0?AUA@@@81" }
// CHECK: @"\01__TI2?AUB@@" = constant %throw.info.type { i32 0, void ()* bitcast (void (%struct.B*)* @"\01??1B@@QAE@XZ" to void ()*), i32 ()* null, %catchable.array.type* bitcast ({ i32, %catchable.type*, %catchable.type* }* @"\01__CTA2?AUB@@" to %catchable.array.type*) }
