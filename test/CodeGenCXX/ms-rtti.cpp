...
//CHECK: @"\01??_R1A@?0A@EN@second@@8" = linkonce_odr constant { i8*, i32, i32, i32, i32, i32 } { i8* bitcast ({ i8**, i32, [13 x i8] }* @"\01??_R0?AVsecond@@@8" to i8*), i32 1, i32 0, i32 -1, i32 0, i32 77 }
...
//CHECK: @"\01??_R2third@@8" = linkonce_odr constant [3 x { i8*, i32, i32, i32, i32, i32 }*] [{ i8*, i32, i32, i32, i32, i32 }* @"\01??_R1A@?0A@EA@third@@8", { i8*, i32, i32, i32, i32, i32 }* @"\01??_R1A@?0A@EN@second@@8", { i8*, i32, i32, i32, i32, i32 }* @"\01??_R1A@?0A@EN@first@@8"]
//CHECK: @"\01??_R3third@@8" = linkonce_odr constant { i32, i32, i32, i8* } { i32 0, i32 0, i32 3, i8* bitcast ([3 x { i8*, i32, i32, i32, i32, i32 }*]* @"\01??_R2third@@8" to i8*) }
